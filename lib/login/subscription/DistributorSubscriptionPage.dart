...
import 'package:coffee/login/distributorPage.dart';
import 'package:flutter/material.dart';
import 'package:coffee/constants.dart';

class DistributorSubscriptionPage extends StatelessWidget {
  const DistributorSubscriptionPage({super.key});
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const DistributorProfilePagelogin(),
                  ),
                );
              },
