...
import 'package:coffee/cupping/Affective/affective_step7.dart';
import 'package:coffee/cupping/model_provider.dart/cupping_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class AffectiveStep6 extends StatefulWidget {
  const AffectiveStep6({super.key});

  @override
  State<AffectiveStep6> createState() => _AffectiveStep6State();
}

class _AffectiveStep6State extends State<AffectiveStep6> {
  // --- State Variables ---
  int? selectedFlavor;
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AffectiveStep7(),
                        ),
                      ),
