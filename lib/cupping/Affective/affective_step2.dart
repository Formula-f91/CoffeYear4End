...
import 'package:coffee/cupping/Affective/affective_step3.dart';
import 'package:coffee/cupping/model_provider.dart/cupping_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class AffectiveStep2 extends StatefulWidget {
  const AffectiveStep2({super.key});

  @override
  State<AffectiveStep2> createState() => _AffectiveStep2State();
}

class _AffectiveStep2State extends State<AffectiveStep2> {
  // --- State Variables ---
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AffectiveStep3(),
                        ),
                      ),
