...
import 'package:coffee/cupping/Affective/affective_step6.dart';
import 'package:coffee/cupping/model_provider.dart/cupping_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class AffectiveStep5 extends StatefulWidget {
  const AffectiveStep5({super.key});

  @override
  State<AffectiveStep5> createState() => _AffectiveStep5State();
}

class _AffectiveStep5State extends State<AffectiveStep5> {
  // --- State Variables ---
  int? selectedFlavor;
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AffectiveStep6(),
                        ),
                      ),
