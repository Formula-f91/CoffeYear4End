...
import 'package:coffee/cupping/Affective/affective_step2.dart';
import 'package:coffee/cupping/model_provider.dart/cupping_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class AffectiveStep1 extends StatefulWidget {
  const AffectiveStep1({super.key});

  @override
  State<AffectiveStep1> createState() => _AffectiveStep1State();
}

class _AffectiveStep1State extends State<AffectiveStep1> {
  // --- State Variables ---
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AffectiveStep2(),
                        ),
                      ),
