...
class AffectiveSuccess extends StatefulWidget {
  const AffectiveSuccess({super.key});

  @override
  State<AffectiveSuccess> createState() => _AffectiveSuccessState();
}

class _AffectiveSuccessState extends State<AffectiveSuccess> {
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const AffectiveChart(),
                          ),
                        );
                      },
