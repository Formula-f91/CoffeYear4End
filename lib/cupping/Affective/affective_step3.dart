...
import 'package:coffee/cupping/Affective/affective_step4.dart';
import 'package:coffee/cupping/model_provider.dart/cupping_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class AffectiveStep3 extends StatefulWidget {
  const AffectiveStep3({super.key});

  @override
  State<AffectiveStep3> createState() => _AffectiveStep3State();
}

class _AffectiveStep3State extends State<AffectiveStep3> {
  // --- State Variables ---
  int? selectedFlavor;
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AffectiveStep4(),
                        ),
                      ),
