...
import 'package:coffee/cupping/Descriptive/DescriptiveStep5.dart';
import 'package:coffee/cupping/model_provider.dart/cupping_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class DescriptiveStep4 extends StatefulWidget {
  const DescriptiveStep4({super.key});

  @override
  State<DescriptiveStep4> createState() => DescriptiveStep4state();
}

class DescriptiveStep4state extends State<DescriptiveStep4> {
  // --- State Variables ---
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const DescriptiveStep5(),
                        ),
                      ),
