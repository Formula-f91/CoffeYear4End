...
import 'package:coffee/cupping/Descriptive/DescriptiveStep2.dart';
...
class DescriptiveStep1 extends StatefulWidget {
  const DescriptiveStep1({super.key});

  @override
  State<DescriptiveStep1> createState() => DescriptiveStep1state();
}

class DescriptiveStep1state extends State<DescriptiveStep1> {
  // --- State Variables ---
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const DescriptiveStep2(),
                        ),
                      ),
