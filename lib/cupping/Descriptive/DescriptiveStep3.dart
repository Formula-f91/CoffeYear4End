...
import 'package:coffee/cupping/Descriptive/DescriptiveStep4.dart';
import 'package:coffee/cupping/model_provider.dart/cupping_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class DescriptiveStep3 extends StatefulWidget {
  const DescriptiveStep3({super.key});

  @override
  State<DescriptiveStep3> createState() => DescriptiveStep3state();
}

class DescriptiveStep3state extends State<DescriptiveStep3> {
  // --- State Variables ---
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const DescriptiveStep4(),
                        ),
                      ),
