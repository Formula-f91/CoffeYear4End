...
import 'package:coffee/cupping/Descriptive/DescriptiveStep3.dart';
...
class DescriptiveStep2 extends StatefulWidget {
  const DescriptiveStep2({super.key});

  @override
  State<DescriptiveStep2> createState() => DescriptiveStep2state();
}

class DescriptiveStep2state extends State<DescriptiveStep2> {
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const DescriptiveStep3(),
                        ),
                      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDescriptorBox(
            items: selectedFlavorDescriptors,
            onRemove: (d) =>
          ...
          _buildDescriptorBox(
            items: selectedMainTastes,
            onRemove: (d) => setState(() => selectedMainTastes.remove(d)),
          ),
  ...
  // ── Shared descriptor display box ──
  Widget _buildDescriptorBox({
