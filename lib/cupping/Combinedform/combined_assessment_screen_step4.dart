...
import 'package:coffee/cupping/Combinedform/combined_assessment_screen_step5.dart';
import 'package:coffee/cupping/model_provider.dart/cupping_provider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class CombinedAssessmentScreenStep4 extends StatefulWidget {
  const CombinedAssessmentScreenStep4({super.key});

  @override
  State<CombinedAssessmentScreenStep4> createState() =>
      _CombinedAssessmentScreenStep2State();
}

class _CombinedAssessmentScreenStep2State
    extends State<CombinedAssessmentScreenStep4> {
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const CombinedAssessmentScreenStep5(),
                        ),
                      ),
