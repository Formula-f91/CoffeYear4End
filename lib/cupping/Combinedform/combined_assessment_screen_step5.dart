...
import 'package:coffee/cupping/Combinedform/combined_assessment_screen_step6.dart';
...
class CombinedAssessmentScreenStep5 extends StatefulWidget {
  const CombinedAssessmentScreenStep5({super.key});

  @override
  State<CombinedAssessmentScreenStep5> createState() =>
      _CombinedAssessmentScreenStep2State();
}

class _CombinedAssessmentScreenStep2State
    extends State<CombinedAssessmentScreenStep5> {
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const CombinedAssessmentScreenStep6(),
                        ),
                      ),
        ...
        children: List.generate(
          ...
          (index) => Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: index <= 4 ? secondaryColor2 : Colors.grey.shade200,
