...
class _CombinedNavigator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Navigator(
      onGenerateRoute: (s) =>
          MaterialPageRoute(settings: s, builder: (_) => const _Step1()),
    );
  }
}
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                session?.cuppingName ?? "Combined Assessment",
                style: const TextStyle(
                  color: Colors.white,
            ...
            Expanded(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    d.descriptiveTotal.toStringAsFixed(0),
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                      color: secondaryColor2,
...
Widget _cTabSwitcher(bool isDescriptive, void Function(bool) onToggle) => Row(
  children: [
    Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              bottom: BorderSide(
                color: isDescriptive ? primaryColor2 : Colors.transparent,
                width: 2,
              ),
            ),
          ),
          child: Text(
            ...
            style: TextStyle(
              color: isDescriptive ? primaryColor2 : Colors.grey.shade600,
              fontWeight: FontWeight.w600,
              fontSize: 16,
            ),
          ),
...
Widget _cDescriptorBox(List<String> items, void Function(String) onRemove) {
  ...
  return Container(
    ...
    child: items.isEmpty
        ? const Center(
            child: Text(
              'No descriptors added yet. Tap Add.',
...
Widget _cAddRow(String label, VoidCallback onTap) => Row(
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: sel ? primaryColor2 : Colors.grey.shade400,
                width: 1.5,
              ),
            ),
            child: Center(
  ...
  children: [
    ...
    SliderTheme(
      data: SliderTheme.of(context).copyWith(
        ...
        thumbShape: _CBalloon(
          thumbRadius: 10,
          thumbValue: val.toInt(),
          color: secondaryColor2,
        ),
          ...
          child: Stack(
            ...
            children: [
              Positioned(
                left: pos(3.0),
                top: -12,
                child: Container(width: 1.5, height: 20, color: primaryColor2),
              ),
              Positioned(
                left: pos(7.0),
                top: -12,
...
class _Step1State extends State<_Step1> {
  ...
  void _showSheet(CombinedProvider p) {
    showModalBottomSheet(
      ...
      builder: (_) => FragranceAromaDescriptorSheet(
        ...
        onApply: (s) {
          p.setFragranceAromaDescriptors(s);
  ...
  @override
  Widget build(BuildContext context) {
    return Consumer<CombinedProvider>(
      builder: (_, p, __) {
        final d = p.currentData;
        ...
        return Scaffold(
          ...
          bottomNavigationBar: _cBottomNav(
            context,
            onBack: () => Navigator.of(context, rootNavigator: true).pop(),
            onNext: () {
  ...
  void _showFlavorSheet(CombinedProvider p) {
    showModalBottomSheet(
      ...
      builder: (_) => FragranceAromaDescriptorSheet(
        ...
        onApply: (s) {
          p.setFlavorAftertasteDescriptors(s);
          Navigator.pop(context);
        },
      ),
    );
                    ...
                    children: [
                      ...
                      if (_isDesc) ...[
                        ...
                        _cDescriptorBox(
                          d.mainTastes,
                          (x) => p.setMainTastes(
                            List.from(d.mainTastes)..remove(x),
                          ),
                        ),
                      ] else ...[
                        const Text(
        ...
        return Scaffold(
          ...
          bottomNavigationBar: _cBottomNav(
            ...
            onNext: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const _Step6()),
              );
            },
          ),
          body: Column(
          ...
          bottomNavigationBar: _cBottomNav(
            ...
            onNext: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => CombinedChartResult(provider: p),
                ),
              );
            },
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_isDesc) ...[
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: on ? _orange : Colors.grey.shade300,
                                  ),
                                ),
                                child: Icon(
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: on ? _red : Colors.grey.shade300,
                                  ),
                                ),
                                child: Icon(
                                  Icons.local_cafe_outlined,
                        ...
                        const SizedBox(height: 12),
                        ...d.defects.entries.map(
                          (e) => _defectItem(
                            e.key,
                            e.value,
                            () => p.toggleDefect(e.key),
                          ),
                        ),
                      ],
                      const SizedBox(height: 24),
  ...
  Widget _defectItem(String title, bool checked, VoidCallback onTap) =>
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: checked ? primaryColor2 : Colors.grey.shade300,
            width: 1.5,
          ),
        ),
        child: InkWell(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.white,
                  border: Border.all(
                    color: checked ? primaryColor2 : Colors.grey.shade400,
                    width: 2,
                  ),
...
// ─────────────────────────────────────────────────────────────────────────────
class CombinedChartResult extends StatefulWidget {
  final CombinedProvider provider;
  const CombinedChartResult({super.key, required this.provider});
  @override
  State<CombinedChartResult> createState() => _CombinedChartResultState();
}

class _CombinedChartResultState extends State<CombinedChartResult> {
  int _selectedSampleIndex = 0;
  static const _barBlue = Color(0xFF1A3A8F);
  static const _orange = Color(0xFFFF8D28);
  static const _red = Color(0xFFB3261E);

  CombinedSampleData? get _data =>
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: LinearProgressIndicator(
            ...
            backgroundColor: Colors.grey.shade200,
            valueColor: AlwaysStoppedAnimation<Color>(
              (score ?? 0) > 0 ? _barBlue : Colors.grey.shade300,
            ),
          ),
        ),
      ],
            ...
            .map(
              (d) => Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: const Color(0xFF1E52C6).withOpacity(0.3),
                  ),
                ),
                child: Text(
                  d,
  ...
  Widget _cupRow(String label, List<bool> cups, Color activeColor) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        ...
        children: List.generate(
          ...
          (i) => Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: cups[i] ? activeColor : Colors.grey.shade300,
              ),
            ),
            child: Icon(
              Icons.local_cafe_outlined,
              color: cups[i] ? Colors.white : Colors.grey.shade400,
              size: 22,
            ),
          ),
        ),
  ...
  Widget _scoreSummary(CombinedSampleData d) => Container(
    ...
    child: Column(
      children: [
        _sumRow(
          "Descriptive Total",
          d.descriptiveTotal.toStringAsFixed(1),
          null,
        ),
        ...
        _sumRow(
          "Uniformity",
          "+${d.uniformCups.where((v) => v).length * 2}",
          Colors.green,
        ),
        const SizedBox(height: 4),
        _sumRow(
          "Clean Cup",
          "+${d.cleanCups.where((v) => v).length * 2}",
          Colors.green,
        ),
        if (d.defects.values.any((v) => v)) ...[
          const SizedBox(height: 4),
          _sumRow(
            "Defect Penalty",
            "-${d.defects.values.where((v) => v).length * 4}",
            Colors.red,
          ),
        ],
      ],
  ...
  Widget _sumRow(String label, String val, Color? color) => Row(
    mainAxisAlignment: MainAxisAlignment.spaceBetween,
    children: [
