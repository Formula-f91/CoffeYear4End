...
import 'package:coffee/cupping/Combinedform/combined_assessment_screen_step2.dart';
...
class CombinedAssessmentScreen extends StatefulWidget {
  const CombinedAssessmentScreen({super.key});

  @override
  State<CombinedAssessmentScreen> createState() =>
      _CombinedAssessmentScreenState();
}

class _CombinedAssessmentScreenState extends State<CombinedAssessmentScreen> {
  // --- State Variables ---
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const CombinedAssessmentScreenStep2(),
                        ),
                      ),
        ...
        children: List.generate(
          ...
          (index) => Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: index == 0 ? secondaryColor2 : Colors.grey.shade200,
