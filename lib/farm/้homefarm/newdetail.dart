  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // --- เพิ่มไอคอน Setting ด้านขวา ---
        actions: [
          Padding(
            padding: const EdgeInsets.only(right: 8.0),
            child: IconButton(
              icon: Image.asset(
                'assets/icon/settingicon.png', // Path รูปภาพที่ระบุ
                width: 24,
                height: 24,
              ),
              onPressed: () {
                // ใส่คำสั่งเมื่อกดปุ่ม Setting ตรงนี้
              },
            ),
          ),
        ],
      ...
      body: Column(
        children: [
          ...
          // Join Evaluation Button (คงไว้ตามต้นฉบับ)
          Container(
            ...
            child: OutlinedButton(
              // เปลี่ยนเป็น OutlinedButton เพื่อเน้นงานขอบ
              onPressed: () {
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  color: secondaryColor2, // ข้อความสี #947257
                ),
              ),
            ),
          ),
