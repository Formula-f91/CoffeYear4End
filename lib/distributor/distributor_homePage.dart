...
// เปลี่ยน OrderPage เป็น StatusPage หรือหน้าที่คุณต้องการให้ลิงก์ไป
...
class SellerHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // เอา SafeArea ออก เพราะเราจะให้รูปส่วนหัวทะลุขึ้นไปถึงแถบ Status bar ด้านบนสุด
  ...
  Widget _buildHeader(BuildContext context) {
    // ดึงระยะ Notch (รอยบากด้านบน) ของแต่ละเครื่อง
    final double topPadding = MediaQuery.of(context).padding.top;
    
    // คำนวณความสูงให้ยืดหยุ่นตามหน้าจอ
    final double bgHeight = 140.0 + topPadding; // ความสูงกล่องรูปภาพส่วนหัว
    final double stackHeight = bgHeight + 65.0; // ความสูงรวมถึงกล่องสีขาวที่ซ้อนอยู่
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Text(
                    "XXXXXXXXXXXX",
                    style: TextStyle(
                      color: Colors.white, // หากรูปพื้นหลังสว่างไป อาจจะต้องเปลี่ยนสีตัวหนังสือตรงนี้
                      fontSize: 18,
